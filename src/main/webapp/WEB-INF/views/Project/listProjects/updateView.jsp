				...
				<div class="col-md-12">
					<div class="content-panel">
						...
						<form:form method="POST" action="/update" commandName="project">
							<form:input type="hidden" path="pamount" class="form-control"
								id="pamount" name="pamount" value="${project.pamount}" />
							<form:input type="hidden" path="lno" id="lno"
								class="form-control" name="lno" value="${project.lno}" />
							<form:input type="hidden" path="uno" id="uno"
								class="form-control" name="uno" value="${project.uno}" />
							<table class="table">
								<tr>
									<td colspan="2"
									...
									<td>
										<div class="btn-group">
											<a class="btn btn-default btn-width"
												style="text-align: left;"><span id="selectedLabel">${project.ltitle}</span></a>
											<a class="btn btn-default dropdown-toggle"
												data-toggle="dropdown"><span class="caret"
												style="height: 10px; margin-top: 10px;"></span></a>
											<ul class="dropdown-menu">
												<c:forEach var="labels" items="${allLabelList}"
													varStatus="status">
