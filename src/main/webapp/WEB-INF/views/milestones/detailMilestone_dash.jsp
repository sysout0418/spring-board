	...
	<section class="wrapper site-min-height">
		<table class="table">
			...
			<tr>
				...
				<td><c:if test="${milestone.mstatement=='000'}">Open</c:if> <c:if
						test="${milestone.mstatement=='001'}">Closed</c:if></td>
				<td>${milestone.mduedate}</td>
			<tr>
				<td colspan="4">
					<h4>Progress</h4> ${countIssues} issues: ${countOpenIssues} open
					and <fmt:formatNumber value="${countClosedIssues}"
						maxIntegerDigits="1" /> closed ${completeIssuePercent}% complete
				...
				<td colspan="4">
					<div class="progress">
						<div class="progress-bar progress-bar-success" role="progressbar"
							...
							style="width: ${completeIssuePercent}%;"></div>
					</div>
				</td>
			</tr>
		</table>
