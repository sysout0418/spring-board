	...
	<header class="header black-bg">
		...
		<div class="nav notify-row" id="top_menu">
			...
			<ul class="nav top-menu">
				...
				<li class="dropdown" data-toggle="tooltip" data-placement="bottom"
					title="Your Projects"><a data-toggle="dropdown"
					...
					<ul class="dropdown-menu extended tasks-bar">
						...
						<c:if test="${projects == 'none'}">
							<li style="text-align: center;"><a href="#"><span
									class="subject"> <span class="from">No milestones
											to show</span></span></a></li>
						</c:if>
						<c:if test="${projects != 'none'}">
								...
								<li><a href="/${project.uno}/${project.pno}">
										...
										<div class="progress progress-striped">
											<div class="progress-bar progress-bar-success"
												...
												aria-valuemax="100"
												style="width: ${project.completeIssuePercent}%">
												<span class="sr-only">${project.completeIssuePercent}%
				...
				<li id="header_inbox_bar" class="dropdown" data-toggle="tooltip"
					data-placement="bottom" title="Requested projects"><a
					...
					<ul class="dropdown-menu extended inbox">
						...
						<c:if test="${message == 'none'}">
							<li style="text-align: center;"><a href="#"><span
									class="subject"> <span class="from">No requests
											to show</span></span></a></li>
						</c:if>
						<c:if test="${message != 'none'}">
							<c:forEach var="message" items="${message}">
								<li><a href="/requestProject/requested">
										<div
											style="background-color: ${message.profileBgColor}; width:40px; height:40px; line-height:40px; display:inline-block; float: left; text-align:center;">
										...
										<div style="float: left;">
											<span class="subject"> <span class="from">${message.uname}</span>
												<span class="time">${message.regDate}</span>
											</span> <span class="message"> <c:choose>
		...
		<div class="top-menu">
			...
			<ul class="nav pull-right top-menu">
				<li><a href="http://redmine.nbreds.com:32/" target="_blank"
					style="margin-top: 15px;" data-toggle="tooltip"
					data-placement="bottom" title="Redmine"> <i
						class="fa fa-calendar-o" aria-hidden="true"></i></a></li>
				<li><a href="http://gitlab.nbreds.com:30" target="_blank"
					style="margin-top: 15px;" data-toggle="tooltip"
					data-placement="bottom" title="GitLab"> <i class="fa fa-git"
						aria-hidden="true"></i></a></li>
				<li><a href="http://192.168.0.7:5000/" target="_blank"
					style="margin-top: 15px;" data-toggle="tooltip"
